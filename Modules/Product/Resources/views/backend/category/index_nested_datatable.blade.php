                ...
                <x-slot name="toolbar">
                  ...
                  <div class="input-group flex-nowrap">
                    ...
                    @hasPermission('create_subcategories')
                      <button type="button" class="btn btn-primary" data-crud-id="{{0}}" title="{{ __('messages.create') }} {{ __('category.sub_category') }}"><i class="fas fa-plus-circle me-2"></i>{{ __('messages.new') }}</button>
                    @endhasPermission
