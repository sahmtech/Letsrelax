<div class="d-flex gap-2 align-items-center">
    ...
    <a href="{{ route('backend.locations.destroy', $data->id) }}" id="delete-locations-{{ $data->id }}"
        ...
        data-confirm="{{ __('messages.are_you_sure?', ['module' => __('location.title'), 'name' => $data->name]) }}"> <i
